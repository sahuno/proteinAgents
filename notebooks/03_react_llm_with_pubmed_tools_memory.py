...
# tools_blocks = [search_pubmed, concatenate_pubmed_queries]
...
sys_msg = SystemMessage(content="""You are a Molecular Biologist and an expert in constructing Advanced Pubmed Queries. 
                        ...
                        Users give you examples of protocols they are interested in.
                        They also give examples of protocols they are not interested in

                         you an idea of what they are interested in and you would give me a refined pubmed query that can be used to retrieve those papers. 
